...
la fase 11 (Consistency Review), pero puede ejecutarse manualmente para
auditar el blueprint en cualquier momento.
...
- El reporte se escribe en `review/` para no mezclarse con los documentos
  del blueprint.
- El software-architect no debería avanzar a la fase 12 si el veredicto
  es `BLOCKED`.
